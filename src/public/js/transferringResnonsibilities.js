...
const btn_changed = document.querySelectorAll("#btn_changed");
...
menu_icon.addEventListener("click", () => {
  ...
  // espacio de el boton de la vista transfering
  btn_changed.forEach((it) =>{
    it.classList.toggle("espacio_btn");
  });
...
// MINI MENU PARA MOSTRAR INFORMACION DE LA BASE DE DATOS
const acordion = document.querySelectorAll(".opcion")

// POR CADA cada item de calse item, si le dan click va hacer algo
